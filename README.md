...
```bash
# Clone Ralphus
git clone https://github.com/yourusername/ralphus.git
cd your-project

# Copy the essentials
cp ralphus/files/loop.sh .
cp ralphus/files/PROMPT_plan.md .
cp ralphus/files/PROMPT_build.md .
cp ralphus/files/AGENTS.md .
...
├── AGENTS.md                  # "How to run tests" (Sisyphus's cheat sheet)
...
See the `/homelab-ralphus` skill for full remote orchestration.
