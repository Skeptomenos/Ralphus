...
0b. Study @RESEARCH_PLAN.md (if present). If missing, use @RESEARCH_PLAN_REFERENCE.md as a format guide.
...
999999. Do not update REFERENCE files. Only update @RESEARCH_PLAN.md in the project root.
